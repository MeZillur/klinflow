    ...
    <header class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div>
            ...
            <p class="text-sm text-slate-500">
                Capture a new expense voucher for <?= $h($orgName) ?> — with optional VAT and WHT.
            </p>
        </div>
        ...
        $tabs = [
            ...
            ['New expense', $module_base.'/expenses/create', true],
        ];
        ?>
            ...
            <form method="post"
                ...
                <div class="grid gap-3 md:grid-cols-3">
                    ...
                    <div class="md:col-span-1">
                        ...
                        <input type="text"
                               ...
                               placeholder="Rent, Utilities, Travel…"
                               class="w-full rounded-lg border border-slate-200 px-3 py-1.5 text-xs focus:border-emerald-600 focus:outline-none focus:ring-1 focus:ring-emerald-600">
                    </div>
                </div>
                ...
                <div class="grid gap-3 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text"
                               ...
                               placeholder="Vendor / employee / landlord…"
                               class="w-full rounded-lg border border-slate-200 px-3 py-1.5 text-xs focus:border-emerald-600 focus:outline-none focus:ring-1 focus:ring-emerald-600">
                    </div>
                    <div>
                        <label class="mb-1 block text-[11px] font-medium text-slate-700">
                        ...
                        <input type="text"
                               ...
                               placeholder="Bill no, memo, trip ref…"
                               class="w-full rounded-lg border border-slate-200 px-3 py-1.5 text-xs focus:border-emerald-600 focus:outline-none focus:ring-1 focus:ring-emerald-600">
                    </div>
                </div>
                ...
                <div class="grid gap-3 md:grid-cols-3">
                    ...
                    <div class="flex items-end text-[11px] text-slate-500">
                        Net impact and GL posting will be calculated when we wire this to the engine.
                    </div>
                </div>
        ...
        <aside class="space-y-4">
            <section class="rounded-2xl border border-dashed border-emerald-400 bg-emerald-50/60 px-4 py-4 text-sm text-slate-800">
                ...
                <ul class="ml-6 list-disc space-y-1 text-[13px]">
                    <li>Fill in the basic details: voucher no, date, category and payee.</li>
                    <li>For bills that carry VAT or WHT, capture the tax amounts — they will later feed the VAT/WHT registers.</li>
                    <li>Use <strong>status = Draft</strong> while you’re still collecting approvals; switch to <strong>Posted</strong> after confirmation.</li>
                    <li>Later, this voucher will also push entries into GL and cash/bank ledgers automatically.</li>
                </ul>
            </section>
        </aside>
    </div>
