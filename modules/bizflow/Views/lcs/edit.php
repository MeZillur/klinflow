    ...
    <header class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div>
            ...
            <p class="text-sm text-slate-500">
                Update your import LC details for <?= $h($orgName) ?> — keep bank terms and shipment info accurate.
            </p>
        </div>
            ...
            <form method="post" action="<?= $h($formAction) ?>" class="space-y-6 px-4 py-4 text-xs md:text-[13px]">
                ...
                <div class="mt-4 flex items-center justify-between border-t border-slate-100 pt-3">
                    <p class="text-[11px] text-slate-500">
                        Preview phase: updates will be wired to the <code>biz_lcs</code> engine when posting is enabled.
                    </p>
                    <div class="flex gap-2">
                        <a href="<?= $h($module_base.'/lcs/'.$id) ?>"
        ...
        <aside class="space-y-4">
            <section class="rounded-2xl border border-dashed border-emerald-400 bg-emerald-50/60 px-4 py-4 text-sm text-slate-800">
                ...
                <ul class="ml-6 list-disc space-y-1 text-[13px]">
                    <li>Compare details with the <strong>bank-issued LC</strong> and correct any mismatch here.</li>
                    <li>Update <strong>shipment dates, ports and Incoterm</strong> when amendments come from the bank.</li>
                    <li>Move <strong>Status</strong> and <strong>Lifecycle stage</strong> forward as documents, maturity and retirement happen.</li>
                    <li>Use <strong>Internal notes</strong> to track BB circulars, margin changes and special approval history.</li>
                </ul>
            </section>
        </aside>
    </div>
