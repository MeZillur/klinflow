...
<form method="POST" action="<?= h($base.'/free-products/issue') ?>" class="space-y-6">
  ...
  <div class="flex justify-end">
    <button class="px-4 py-2 rounded-lg bg-emerald-600 text-white hover:bg-emerald-700">Issue</button>
  </div>
</form>